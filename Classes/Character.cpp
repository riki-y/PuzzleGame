...
int Character::getDamage(int ballCount, int chainCount, Character* attacker, Character* defender)
{
    ...
    // 属性ボーナス
    float elementBonus = getElementBouns(attacker->getElement(), defender->getElement());
...
// 属性による攻撃ボーナス
float Character::getElementBouns(Element attackElement, Element defenseElement)
{
    // 攻撃属性
